<template>
  <div class="box" v-if="!showMap">
    <div class="title">
      <el-page-header @back="goBack" content="修改任务"></el-page-header>
    </div>
    <el-form ref="form" :model="form" label-width="80px" :rules="rules">
      ...
      <el-form-item label="任务赏金" prop="money">
        <el-input-number v-model="form.money" :step="1" :precision="1"></el-input-number>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="Submit('form')" class="btn" :loading="loading">提交修改</el-button>
      </el-form-item>
    </el-form>
  </div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      this.form=_this._props.mission;
      this.form.demand=''+this.form.demand;
      ...
      Submit(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.axios({
              method:"post",
              url:"http://localhost:8090/updateMission",
              data:{
                id:vm.form.id,
                name:vm.form.name,
